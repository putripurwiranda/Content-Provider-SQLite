...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            // set up radiobutton
            final RadioButton rdPink = (RadioButton) dialog.findViewById(R.id.rdPink);
            final RadioButton rdYellow = (RadioButton) dialog.findViewById(R.id.rdYellow);
            ...
            btnChange.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (rdPink.isChecked()){
                        mRecyclerView.setBackgroundResource(R.color.pinkBackgroud);
                        Toast.makeText(view.getContext(),"Pink Choosen",Toast.LENGTH_SHORT).show();
                    }
                    if (rdYellow.isChecked()){
                        mRecyclerView.setBackgroundResource(R.color.yellowBackgroud);
                        Toast.makeText(view.getContext(),"Yellow Choosen",Toast.LENGTH_SHORT).show();
                    }
